...
public abstract class AbstractStorageTest {
    protected static final File storageDir =  new File("C:\\projects\\u-rise\\JavaSE-app\\storage");
        ...
        R1.addSection(SectionType.EXPERIENCE,
                new OrganizationSection(
                        new Organization("Organization11", "http://Organization11.ru",
                                ...
                                new Organization.Position(2001, Month.MARCH,
                                        2005, Month.JANUARY, "position2", "content2"))));
    ...
    public void clear() throws Exception {
        storage.clear();
        assertSize(0);
        assertEquals(storage.getAllSorted(), new Resume[0]);
    }
